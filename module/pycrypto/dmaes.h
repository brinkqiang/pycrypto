...
public:
    ...
    CDMAES(const AESKeyLength keyLength);
    virtual ~CDMAES();
    // export_end  
private:
    int Nb;
...
public:
    ...
    pybind11::bytes EncodeECB(std::string in,
        std::string key);

    pybind11::bytes DecodeECB(std::string in,
        std::string key);

    pybind11::bytes EncodeCBC(std::string in,
        std::string key,
        std::string iv);

    pybind11::bytes DecodeCBC(std::string in,
        std::string key,
        std::string iv);

    pybind11::bytes EncodeCFB(std::string in,
        std::string key,
        std::string iv);

    pybind11::bytes DecodeCFB(std::string in,
        std::string key,
        std::string iv);
    // export_end
